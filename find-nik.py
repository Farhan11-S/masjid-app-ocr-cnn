...
def nikFinder(image, img_gray, filename, dir, goodResultLatest, goodResultOld):
    ...
    for (i, c) in enumerate(cnts):
        ...
        if h > 10 and w > 100 and x < 300 and x > 4:
            ...
            aocra_latest = pytesseract.image_to_string(thresh, lang="OCRA-NEW_1", config='--psm 7 --oem 3')
    ...
    return goodResultLatest, goodResultOld
    ...
    for dir in dirs:
        ...
        for filename in files:
            try:
                ...
                continue
    print(f"Good Result Latest: {goodResultLatest}")
    print(f"Good Result Old: {goodResultOld}")
